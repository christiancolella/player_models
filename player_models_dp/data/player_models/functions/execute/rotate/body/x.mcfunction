...
execute store result entity @e[type=armor_stand,tag=selected_player,limit=1] ArmorItems[0].tag.Pose.Body[0] float 0.001 run scoreboard players get #temp temp